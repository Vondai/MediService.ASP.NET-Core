...
namespace MediService.ASP.NET_Core.Data.Migrations
{
    ...
    [Migration("20210818115824_RenamedColumnMessage")]
    partial class RenamedColumnMessage
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MediService.ASP.NET_Core.Data.Models.Review", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MediService.ASP.NET_Core.Data.Models.Message", b =>
                {
                    b.HasOne("MediService.ASP.NET_Core.Data.Models.User", "Recipient")
                        .WithMany("Messages")
